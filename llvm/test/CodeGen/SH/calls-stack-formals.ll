...
define internal void @formals_leaf() noinline {
	ret void
}

define i32 @return_fifth(i32 %a0, i32 %a1, i32 %a2, i32 %a3, i32 %a4) {
...
define ptr @return_sixth_pointer(i32 %a0, i32 %a1, i32 %a2, i32 %a3, i32 %a4, ptr %a5) {
...
define i32 @return_nineteenth(i32 %a0, i32 %a1, i32 %a2, i32 %a3, i32 %a4, i32 %a5, i32 %a6, i32 %a7, i32 %a8, i32 %a9, i32 %a10, i32 %a11, i32 %a12, i32 %a13, i32 %a14, i32 %a15, i32 %a16, i32 %a17, i32 %a18) {
...
define i32 @nonleaf_only_pr_fifth(i32 %a0, i32 %a1, i32 %a2, i32 %a3, i32 %a4) {
...
define i32 @fixed_frame_twelve_fifth(i32 %a0, i32 %a1, i32 %a2, i32 %a3, i32 %a4) {
